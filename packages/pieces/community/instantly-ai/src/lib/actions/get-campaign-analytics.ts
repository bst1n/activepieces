...
export const getCampaignAnalyticsAction = createAction({
  ...
  aiMetadata: { description: 'Retrieves performance analytics for a single Instantly campaign by campaign ID — leads contacted, emails sent, opens, replies, bounces, unsubscribes, and opportunities — optionally scoped to a start and end date. Use to report on campaign results. Read-only and idempotent.', idempotent: true },
  props: {
